...
const AlphabetWritingGame = ({ setGameState }) => {
  ...
  return (
    <div className="h-screen flex flex-col font-inter relative overflow-hidden" style={{background: 'linear-gradient(135deg, #e0f7fa 0%, #f3e8ff 100%)'}}>
      {!isFullscreen && (
        <Header
          title={<div className="flex items-center gap-2"><span>{t('writing_game.title')}</span>
            <button
              ...
              style={{ minWidth: 56 }}
              title={isUpper ? t('writing_game.lowercase') : t('writing_game.uppercase')}
            >
